...
## Features
-Tap to jump anywhere on the reel.

-Drag to scrub with live time.

-Fine-scrub by dragging vertically while holding.

-Arrow keys skip ±5s when video focused.
...
-Drag up while scrubbing for fine control.
